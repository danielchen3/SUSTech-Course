...
public class Student {
    public static Student Students(int ID,String name,double escore,double mscore,double cscore){
        return new Student(ID,name,escore,mscore,cscore);
    }
    public int ID;
    public String name;
    public double escore, mscore, cscore, tscore, eqscore, testscore;

    // Student class constructor
    public Student() {}

    public Student(int ID, String name, double escore, double mscore, double cscore) {
        this.ID = ID;
        this.name = name;
        this.escore = escore;
        this.mscore = mscore;
    ...
    public String toString() {
        return "Student " + ID + ", 英语成绩为" + escore + ", 数学成绩为" + mscore + ", 计算机成绩为" + cscore + ", 名字 " + name;
    }
}